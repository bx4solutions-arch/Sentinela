...
// Sentinela design system — herança 1:1 do MeuJurídico (Inter, radius 0.5rem,
// neutros slate, semânticos, primary navy 224 85% 29%). Tailwind v3.4 (paridade
// agora; decisão a revisitar ao graduar para F1 — ver docs/design-system.md).
const config: Config = {
  darkMode: ["class"],
  content: [
    "./app/**/*.{ts,tsx}",
