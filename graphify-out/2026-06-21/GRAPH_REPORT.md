...
## Corpus Check
- 152 files · ~543,743 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1319 nodes · 1853 edges · 131 communities (96 shown, 35 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 58 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `82e6f2cc`
...
Cohesion: 0.07
Nodes (46): ChanceScore(), ImminenceBadge(), imVariant, MockBanner(), NotificationBell(), RadarCard(), SourceLinks(), StageKanban() (+38 more)

### Community 3 - "Community 3"
Cohesion: 0.18
Nodes (15): AiConfigView, getAiConfig(), saveAiConfig(), ConfiguracoesPage(), analisarComIA(), EditalCtx, decrypt(), encrypt() (+7 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (28): Badge(), badgeVariants, ButtonProps, buttonVariants, Card(), CardContent(), CardDescription(), CardFooter() (+20 more)
...
Cohesion: 0.14
Nodes (19): Select, itensAplicaveis(), Municipio, municipiosDaUf(), resolveMunicipio(), EditalSinal, sinaisEdital(), Sinal (+11 more)
...
Cohesion: 0.13
Nodes (18): addDocumento(), deleteDocumento(), slug(), brl(), Doc, EmpresaPage(), CERTIDAO_LABEL, CERTIDAO_TIPOS (+10 more)
...
Cohesion: 0.14
Nodes (14): Button, addDocLicitacao(), deleteDocLicitacao(), excluirLicitacao(), brl(), dtBR(), Lic, LicitacaoPage() (+6 more)
...
Cohesion: 0.18
Nodes (10): Como rodar o worker em produção (local), Fila executada, Gates respeitados, Pendências (em `BLOQUEIOS.md`), RELATÓRIO DE SESSÃO — 2026-06-20 (modo autônomo), Também nesta sessão (antes do modo autônomo), TASK 1 — Backfill on-demand por célula (cidade) ✅, TASK 2 — Paleta SEM VERDE + mockups ricos sobre dado real ✅ (parcial no pixel) (+2 more)
...
Cohesion: 0.50
Nodes (3): BLOQUEIOS — sessão autônoma 2026-06-20, Contornado, Pendências (não bloqueiam — qualidade/escopo, ficaram para a próxima)
...
Cohesion: 0.18
Nodes (12): DONUT_CORES, DonutDatum, DonutSegmento(), LineTendencia(), ringColor(), ScoreRing(), TrendDatum, DashboardPage() (+4 more)
...
## Knowledge Gaps
- **632 isolated node(s):** `Lic`, `Etapas`, `Op`, `STEPS`, `MESES` (+627 more)
...
- **Why does `PCA — Plano de Contratações Anuais` connect `Community 35` to `Community 33`, `Community 11`, `Community 21`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `Dado-Limpo (Editais + Contratos + Histórico como matéria-prima)` connect `Community 35` to `Community 0`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `Sentinela (Product Under Development)` connect `Community 0` to `Community 35`?**
